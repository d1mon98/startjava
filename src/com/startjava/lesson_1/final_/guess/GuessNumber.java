...
public class GuessNumber {
    ...
    //создайте классы:
    //com.startjava.lesson_1.ff.guess.GuessNumber — отвечает за игровой процесс
    //com.startjava.lesson_1.ff.guess.Player — описывает игроков (один экземпляр класса соответствует одному игроку)
    ...
    //для инициализации поля name в классе com.startjava.lesson_1.ff.guess.Player используйте конструктор

    //созданных игроков передавайте в com.startjava.lesson_1.ff.guess.GuessNumber через ее конструктор и присвойте двум полям с типом com.startjava.lesson_1.ff.guess.Player
